...
// Adaptations:
// 1. Installed only the Select parts required by the General Settings Page.
// 2. Reused the project's aggregate radix-ui dependency and Shared cn public API.
// 3. Removed unused labels, separators, scroll buttons, sizes, and positioning variants.
