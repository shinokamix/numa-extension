...
// Adaptations: installed page-locally, pruned to the left-side Settings sheet, removed the unused RSC directive, and adjusted to project formatting and lint rules.
